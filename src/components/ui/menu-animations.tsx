...
const animationConfigs = {
    "dots-grid": {
        init: (el: HTMLElement) => {
            ...
            dots.forEach((dot, i) => {
                gsap.set(dot, { x: positions[i].x, y: positions[i].y, scale: 1, opacity: 1 });
            });
        },
        ...
        deactivate: (el: HTMLElement) => {
            ...
            dots.forEach((dot, i) => {
                gsap.to(dot, { x: positions[i].x, y: positions[i].y, scale: 1, opacity: 1, ease: "circleEase", duration: 0.6 });
            });
        },
    },
    "text-morph": {
